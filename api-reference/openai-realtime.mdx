...
```http
POST https://api.llmhub.com.cn/v1/realtime/sessions
Content-Type: application/json
Authorization: Bearer $LLM_Hub_API_KEY
...
### WebRTC 连接
- URL: `https://api.llmhub.com.cn/v1/realtime`
- 查询参数: `model`
- 请求头:
...
### WebSocket 连接
- URL: `wss://api.llmhub.com.cn/v1/realtime`
- 查询参数: `model`
- 请求头:
...
async function init() {
  ...
  const baseUrl = "https://api.llmhub.com.cn/v1/realtime";
...
app.get("/session", async (req, res) => {
  const r = await fetch("https://api.llmhub.com.cn/v1/realtime/sessions", {
    method: "POST",
    headers: {
      "Authorization": `Bearer ${process.env.LLM_Hub_API_KEY}`,
      "Content-Type": "application/json",
    },
    body: JSON.stringify({
      model: "gpt-4o-realtime-preview-2024-12-17",
...
const url = "wss://api.llmhub.com.cn/v1/realtime?model=gpt-4o-realtime-preview-2024-12-17";
...
LLM_Hub_API_KEY = os.environ.get("LLM_Hub_API_KEY")

url = "wss://api.llmhub.com.cn/v1/realtime?model=gpt-4o-realtime-preview-2024-12-17"
headers = [
    "Authorization: Bearer " + LLM_Hub_API_KEY,
    "OpenAI-Beta: realtime=v1"
]
...
const ws = new WebSocket(
  "wss://api.llmhub.com.cn/v1/realtime?model=gpt-4o-realtime-preview-2024-12-17",
  [
    "realtime",
    // 认证
    "openai-insecure-api-key." + LLM_Hub_API_KEY,
    // 可选
...
| 请求头 | 类型 | 说明 | 示例值 |
|--------|------|------|---------|
| Authorization | 字符串 | 认证令牌 | Bearer $LLM_Hub_API_KEY |
