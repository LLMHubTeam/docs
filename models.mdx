---
title: "模型"
description: "通过 OpenRouter 的统一 API 访问所有主流语言模型 (LLM)。浏览可用的模型，比较功能，并与您首选的提供商集成。"
---

在我们的网站 (/models) 上或使用我们的 API (/docs/api-reference/list-available-models)（包括 RSS）探索和浏览 400 多个模型和提供商。
